...
class Source extends _core__WEBPACK_IMPORTED_MODULE_0__["Chip"] {
    constructor(x, name) {
        super('SRC - ' + name, _core__WEBPACK_IMPORTED_MODULE_0__["ChipType"].Source);
        this.x = x;
        this.outputs.add(x);
    }
}
class AndGate extends _core__WEBPACK_IMPORTED_MODULE_0__["Chip"] {
    constructor(name) {
        super('AND - ' + name, _core__WEBPACK_IMPORTED_MODULE_0__["ChipType"].And);
        this._a = null;
        this._b = null;
        this.a = (value) => this._a = value;
        this.b = (value) => this._b = value;
        this.x = () => {
            if (_core__WEBPACK_IMPORTED_MODULE_0__["Chip"].anyNulls(this._a, this._b)) {
                return null;
            }
...
class OrGate extends _core__WEBPACK_IMPORTED_MODULE_0__["Chip"] {
    constructor(name) {
        super('OR - ' + name, _core__WEBPACK_IMPORTED_MODULE_0__["ChipType"].Or);
        this._a = null;
        this._b = null;
        this.a = (value) => this._a = value;
        this.b = (value) => this._b = value;
...
class NotGate extends _core__WEBPACK_IMPORTED_MODULE_0__["Chip"] {
    constructor(name) {
        super('NOT = ' + name, _core__WEBPACK_IMPORTED_MODULE_0__["ChipType"].Not);
        this._a = null;
        this.a = (value) => this._a = value;
        this.x = () => this._a === null ? null : !this._a;
        this.inputs.add(this.a);
        this.outputs.add(this.x);
    }
}
class NandGate extends _core__WEBPACK_IMPORTED_MODULE_0__["Chip"] {
    constructor(name) {
        super('NAND - ' + name, _core__WEBPACK_IMPORTED_MODULE_0__["ChipType"].Nand);
        this._a = null;
        this._b = null;
        this.a = (value) => this._a = value;
        this.b = (value) => this._b = value;
...
class TriState extends _core__WEBPACK_IMPORTED_MODULE_0__["Chip"] {
    constructor(name) {
        super('TRI - ' + name, _core__WEBPACK_IMPORTED_MODULE_0__["ChipType"].TriState);
        this.a = (value) => this._a = value;
        this.en = (value) => this._en = value;
        this.x = () => this._en ? this._a : null;
        this.inputs.add(this.a);
...
class Wire {
    constructor(name, outputs, inputs) {
...
let currX = 0;
let currY = 0;
class BoardManager extends _core__WEBPACK_IMPORTED_MODULE_1__["Group"] {
    constructor() {
        super(...arguments);
        this.wires = [];
        this.chips = [];
    ...
    addWire(wire) {
        ...
        const sprite = new _sprites_wire_sprite__WEBPACK_IMPORTED_MODULE_2__["WireSprite"](this, wire);
        sprite.setParent(this);
    ...
    removeEntity(entity) {
        ...
        // Find the chip
        const chipIdx = this.chipSprites.indexOf(entity);
        if (chipIdx === -1) {
            return;
        }
...
(function (PointerMode) {
    PointerMode[PointerMode["Move"] = 0] = "Move";
    PointerMode[PointerMode["Holding"] = 1] = "Holding";
    PointerMode[PointerMode["Delete"] = 2] = "Delete";
...
class SourceSprite extends _chip_sprite__WEBPACK_IMPORTED_MODULE_0__["ChipSprite"] {
    constructor(source) {
        super();
        this._source = source;
    }
...
/* harmony import */ var _circuit_chips__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./circuit/chips */ "./src/circuit/chips.ts");
/* harmony import */ var _circuit_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./circuit/core */ "./src/circuit/core.ts");
...
/* harmony import */ var _graphics_board_manager__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./graphics/board-manager */ "./src/graphics/board-manager.ts");
...
const aElem = jquery__WEBPACK_IMPORTED_MODULE_0__('#a');
const bElem = jquery__WEBPACK_IMPORTED_MODULE_0__('#b');
const aSrc = new _circuit_chips__WEBPACK_IMPORTED_MODULE_1__["Source"](() => aElem.prop('checked'), 'b');
const bSrc = new _circuit_chips__WEBPACK_IMPORTED_MODULE_1__["Source"](() => bElem.prop('checked'), 'b');
const nandGate = new _circuit_chips__WEBPACK_IMPORTED_MODULE_1__["NandGate"]('0');
const orGate = new _circuit_chips__WEBPACK_IMPORTED_MODULE_1__["OrGate"]('1');
const notGate = new _circuit_chips__WEBPACK_IMPORTED_MODULE_1__["NotGate"]('2');
const chips = [aSrc, bSrc, nandGate, orGate, notGate];
const a = new _circuit_core__WEBPACK_IMPORTED_MODULE_2__["Wire"]('a_out', [aSrc.x], [nandGate.a]);
const b = new _circuit_core__WEBPACK_IMPORTED_MODULE_2__["Wire"]('b_out', [bSrc.x], [nandGate.b]);
const andOut = new _circuit_core__WEBPACK_IMPORTED_MODULE_2__["Wire"]('nand_out', [nandGate.x], [notGate.a]);
const notOut = new _circuit_core__WEBPACK_IMPORTED_MODULE_2__["Wire"]('not_out', [notGate.x]);
const wires = [a, b, andOut, notOut];
const bm = new _graphics_board_manager__WEBPACK_IMPORTED_MODULE_4__["BoardManager"]();

...
var BoardManager = /** @class */ (function (_super) {
    ...
    BoardManager.prototype.removeChip = function (chip) {
        var idx = this.chips.indexOf(chip);
        if (idx === -1) {
            return;
        }
        // oh boy
...
var Pointer = /** @class */ (function (_super) {
    ...
    function Pointer(canvas, bm) {
        var _this = _super.call(this) || this;
        canvas.onmousemove = function (e) { return _this.onMouseMove(e); };
        _this._bm = bm;
        _this._mode = PointerMode.Move;
        return _this;
    }
    Object.defineProperty(Pointer.prototype, "heldEntity", {
        get: function () {
    ...
    Pointer.prototype.setMode = function (mode) {
    ...
    Pointer.prototype.onClick = function (point, ctx) {
        switch (this._mode) {
    ...
    Pointer.prototype.grab = function (point, ctx) {
        var chip = this._bm.cointainsPoint(point, ctx);
        if (!chip) {
            return;
        }
    ...
    Pointer.prototype.delete = function (point, ctx) {
        var chip = this._bm.cointainsPoint(point, ctx);
        if (chip) {
...
var computeCanvas = jquery__WEBPACK_IMPORTED_MODULE_0__('#compute').get()[0];
var context = computeCanvas.getContext('2d');
var aElem = jquery__WEBPACK_IMPORTED_MODULE_0__('#a');
var bElem = jquery__WEBPACK_IMPORTED_MODULE_0__('#b');
var aSrc = new _circuit_chips__WEBPACK_IMPORTED_MODULE_1__["Source"](function () { return aElem.prop('checked'); }, 'b');
var bSrc = new _circuit_chips__WEBPACK_IMPORTED_MODULE_1__["Source"](function () { return bElem.prop('checked'); }, 'b');
var nandGate = new _circuit_chips__WEBPACK_IMPORTED_MODULE_1__["NandGate"]('0');
var orGate = new _circuit_chips__WEBPACK_IMPORTED_MODULE_1__["OrGate"]('1');
var notGate = new _circuit_chips__WEBPACK_IMPORTED_MODULE_1__["NotGate"]('2');
var chips = [aSrc, bSrc, nandGate, orGate, notGate];
var a = new _circuit_core__WEBPACK_IMPORTED_MODULE_2__["Wire"]('a_out', [aSrc.x], [nandGate.a]);
var b = new _circuit_core__WEBPACK_IMPORTED_MODULE_2__["Wire"]('b_out', [bSrc.x], [nandGate.b]);
var andOut = new _circuit_core__WEBPACK_IMPORTED_MODULE_2__["Wire"]('nand_out', [nandGate.x], [notGate.a]);
var notOut = new _circuit_core__WEBPACK_IMPORTED_MODULE_2__["Wire"]('not_out', [notGate.x]);
var wires = [a, b, andOut, notOut];
var bm = new _graphics_board_manager__WEBPACK_IMPORTED_MODULE_4__["BoardManager"]();
...
jquery__WEBPACK_IMPORTED_MODULE_0__('input[name=mode]').change(function (e) {
    var input = e.target;
    console.log(input.value);
});
var pointer = new _graphics_pointer__WEBPACK_IMPORTED_MODULE_3__["Pointer"](computeCanvas, bm);
computeCanvas.onclick = function (e) { return pointer.onClick({ x: e.offsetX, y: e.offsetY }, context); };
